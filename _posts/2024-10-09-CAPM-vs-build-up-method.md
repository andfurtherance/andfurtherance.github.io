...
At the core of both CAPM and the Build-Up Method is a deceptively simple question: _How much return should an investor expect for taking on risk?_ In other words, if you’re going to invest in a company, especially one that’s not guaranteed to succeed, how much compensation should you demand for taking that risk?
...
$ \text{Expected Return} = R_f + \text{Equity Risk Premium} + \text{Size Premium} + \text{Industry Risk Premium} + \text{Company-Specific Risk Premium} $
